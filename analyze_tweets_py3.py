...
Description: Script for analyzing tweets to compare the popularity\
 of 3 programming languages: Python, Javascript and ruby
...
tweets['country'] = [tweet['place']['country'] if tweet[
    'place'] != None else None for tweet in tweets_data]
...
tweets_by_prg_lang = [tweets['python'].value_counts()[True], tweets[
    'javascript'].value_counts()[True], tweets['ruby'].value_counts()[True]]
...
# tweets['programming'] = tweets['text'].apply(
#     lambda tweet: word_in_text('programming', tweet))
# tweets['tutorial'] = tweets['text'].apply(
#     lambda tweet: word_in_text('tutorial', tweet))
# tweets['relevant'] = tweets['text'].apply(lambda tweet: word_in_text(
#     'programming', tweet) or word_in_text('tutorial', tweet))

# # Analyzing Tweets by programming language:
# #     Second attempt
# print('Analyzing tweets by programming language: First attempt\n')
# tweets_by_prg_lang = [tweets[tweets['relevant'] == True]['python'].value_counts()[True],
#                       tweets[tweets['relevant'] == True][
#                           'javascript'].value_counts()[True],
...
#     tweets_relevant_with_link['python'] == True]['link'].head())
